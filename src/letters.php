...
function writeStar(){
         ...
         ?><div class="letter" style="width: 110px;" ><?php
                ...
                writePiece("halfline", 50, 15, 90);
                writePiece("halfline", 50, 15, 0);
                writePiece("halfline", 50, 15, 140);
...
function writeHash(){
	 	...
	 	writePiece("halfline", 20, 15, 0);
		writePiece("halfline", 20, 45, 0);
	        writePiece("halfline", 20, 30, 90);
                writePiece("halfline", 60, 30, 90);
...
function writeCarrot(){

         ?><div class="letter" style="width: 100px;" ><?php

 	        writePiece("quarterline", 0, 15, 40);
                writePiece("quarterline", 0, 50, 140);
		...
		foreach ($wordsIn as $wordIn)	{
			...
			$lineLength += $wordlength + 75;
                        ...
                        if ($lineLength > 2000){
                          ...
                          <?php
                          $lineLength = $randWidth + $wordlength + 75;
			  $lineCount++;
